...
###  ا: مضامین (Education Week طرز)

**طوالت:** 800 سے 1000 الفاظ
...
- خوبیاں
- کمزوریاں
- خواندگی، مطالعے یا تعلیم سے مطابقت
- حتمی تجویز

**عمل:**
1. پہلے کتاب کا نام ای میل کریں (پچ)۔
2. قبولیت کے بعد چار ہفتوں کے اندر مکمل جائزہ بھیجیں۔
3. وضاحت کے لیے تدوین کی جا سکتی ہے۔

**حوالہ:** London Review of Books اور اکادمک کتابی جائزوں کا انداز۔

---

###  ج: خطوط

**طوالت:** 400 سے 900 الفاظ
...
2. خط میں شامل حقیقی افراد کی رازداری کا خیال رکھیں — اگر ضروری ہو تو نام تبدیل کیے جا سکتے ہیں۔
...
**طوالت:** ہر نظم زیادہ سے زیادہ 50 سطریں؛ ایک جمع کرانے میں زیادہ سے زیادہ 5 نظمیں
...
### مشترک ہدایات (تمام اقسام)

- صرف اصل اور غیر شائع شدہ تحریریں قبول کی جائیں گی۔
...
- اشاعت کے بعد حقوق مصنف اور کتابومری دونوں کے پاس مشترکہ طور پر رہتے ہیں؛ مصنف اپنی تحریر کہیں اور بھی شائع کر سکتا ہے، بشرطیکہ کتابومری کو بطور اولین ناشر تسلیم کیا جائے۔
- کتابومری کو رد کرنے کا حق حاصل ہے، بلا وجہ بتائے۔
- کوئی معاوضہ نہیں دیا جاتا – یہ ایک رضاکارانہ تعلیمی پلیٹ فارم ہے۔
- متوقع جواب کا وقت ہر سیکشن میں الگ سے بتایا گیا ہے (عام طور پر دو سے چار ہفتے)۔
...
- A brief summary of the book's main argument or content
- Strengths: what the book does well
- Weaknesses or limitations
- Relevance to reading, literacy, or education
- A final recommendation (who should read it and why)

**Process:**
1. Pitch the book title first by email before writing the review.
2. If accepted, submit the full review within four weeks.
3. Reviews will be edited for clarity.

**Reference style:** London Review of Books, academic book reviews
...
2. Please respect the privacy of any real people named in your letter — names can be changed if needed.
...
- Publication rights are shared between the author and Kitabomori; you are free to republish your work elsewhere afterward, provided Kitabomori is credited as first publisher.
...
- Expected response times are listed under each section above (typically two to four weeks).
